...
S {}
E {}
T {PLL testbench 3.3V edition} 1180 0 2 0 0.4 0.4 {}
T {LF : experimental parameter only
VCO : under construction} 530 -110 0 0 0.3 0.3 {}
N 50 -310 50 -260 {
lab=data}
N 550 -260 570 -260 {
lab=#net1}
...
C {devices/lab_wire.sym} 20 -170 0 0 {name=p3 sig_type=std_logic lab=csvb}
